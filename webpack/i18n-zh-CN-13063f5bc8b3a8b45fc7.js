(window.webpackJsonp = window.webpackJsonp || []).push([[12], {
  ...
  CPwy: function (e, t, a) {
    ...
    window.I18N = {
      mockingbot: '墨刀',
      lock_keyhole_win: 'Ctrl + Shift + L',
      lock_keyhole_mac: '⌘ + ⇧ + L',
      group_win: 'Ctrl + G',
      group_mac: '⌘ + G',
      ungroup_win: 'Ctrl + Shift + G',
      ungroup_mac: '⌥ + ⌘ + G',
      ...
      no_permission_to_app: '对不起，您没有访问权限，请联系作者开通权限。',
      state: '状态',
      new: '新建',
      widgets: 'Widgets(1)',
      ...
      devices: {
        android: {
          google_nexus: 'Google Nexus 5',
          google_pixel_2: 'Google Pixel 2',
          google_pixel_2_xl: 'Google Pixel 2 XL (全面屏)',
          samsung: 'Samsung S7',
          Xiaomi: 'Xiaomi 6',
          Huawei: 'Huawei P8',
          Meizu: 'Meizu',
        ...
        iphone: {
          iphone_4: 'iPhone 4',
          iphone_5: 'iPhone 5/SE',
          iphone_6: 'iPhone 6/7/8',
          iphone_6_plus: 'iPhone 6/7/8 Plus',
          iphone_x: 'iPhone X/XS',
          iphone_xs_max: 'iPhone XR/XS Max'
        },
        ipad: {
          ipad_3_4: 'iPad',
          ipad_pro: 'iPad Pro'
      ...
      ipa_device: {
        ...
        not_enabled: '下载 IPA 文件需要提供有效的（个人/企业）苹果开发者证书，在生成 IPA 前，请先联系 <a href="mailto:support@modao.cc">support@modao.cc</a> 提供证书及相关信息。<br><br><a href="http://modao.cc/posts/8022" target="_blank" class="important">查看 IPA 生成说明</a>'
      },
      ...
      search_guides: '搜索教程',
      got_message: '收到一条通知',
      https_only: '双击编辑URL，出于安全考虑，外部网页组件仅支持https协议网站。',
      ...
      content_scrollable: '内容区滚动',
      highlight_clickable: '链接高亮',
      sticky_visible: '批注',
      shell_type: '边框',
      device_shell: '真机',
      default_shell: '默认',
      ...
      connect_to_push_server: '正在连接同步服务器，请稍候…',
      unknown_error: '服务器发生未知错误，我们已经知晓此问题，并正在紧急修复中，为避免数据丢失，请您刷新此页面再进行后续操作。<br><br>错误代码：%s',
      error_403: '您的登录已失效, 请刷新页面后重试',
      error_404: '项目下载失败, 请稍后重试。',
      error_500: '服务器发生未知错误, 错误代码: 500',
      error_project: '因协作项目同时执行删除操作，导致当前项目页面为空，请点击确认将其删除。如有疑问，请联系人工客服。',
      new_version_detected: '检测到您已打开此页面<span>超过 6 小时</span>，目前墨刀长时间运行可能会产生一些无法预知的小问题，为了您的正常使用，请先刷新此页面，我们正在解决此问题，给您带来不便我们深感抱歉。',
      ...
      my_account: '我的帐户',
      signout: '退出登录',
      setting_account: '账户类型',
      setting_plan: '当前方案',
      setting_manage: '操作',
      setting_switch: 'Set Language to: English',
      apps: '项目',
      teams: '团队',
      logout: '登出',
      trial: '试用',
      ...
      tab_active: '当前',
      tab_archive: '归档',
      tab_collaboration: '协作',
      tab_my_teams: '创建的团队',
      tab_joined_teams: '加入的团队',
      no_apps: '无项目',
      no_apps_notification: '通过浏览器下载 Windows、 Mac 客户端创建项目',
      no_apps_or: '或者',
      no_apps_starnote: '查看官方演示项目',
      new_app: '创建项目',
      new_demo_app: '编辑演示项目',
      ...
      no_teams: '无团队',
      no_teams_notification: '通过浏览器下载 Windows、Mac 客户端创建团队',
      collaboration: '成员管理',
      collaborators: '团队成员',
      ...
      download_client_title: '请下载最新版客户端',
      download_client_msg: "此功能需要最新版客户端方可使用，<a class='active-link' href='%client_url' target='_blank'>点击此处下载最新版客户端</a>",
      download_client_or_chrome_title: '请下载最新版客户端或Chrome浏览器',
      download_client_or_chrome_msg: "\n    此功能需要下载\n    <a class='active-link' href='%client_url' target='_blank'>最新版客户端</a>\n    或\n    <a class='active-link' href='%chrome_url' target='_blank'>Chrome浏览器</a>\n    方可使用\n  ",
      export_method: '选择下载格式',
      download_export_file: '手动下载',
      prepared: '准备就绪',
      font_commercial_use_info: '当前项目中若使用了商业字体，请在商用前联系字库厂商购买授权',
      html5_zip: 'HTML 压缩包 [离线]',
      current_png: '当前页 PNG',
      current_pngs: '全部 PNG',
      apk_file: '安卓 APK [离线]',
      commercial_fonts_apk_info: '商用字体将不会被打包进 APK 中',
      commercial_font_tip_preview: '若此项目原型使用了商业字体，请在商用前联系字库厂商购买授权',
      prepare_downloading: '正在为您生成下载文件，请稍候…',
      your_file_is_ready: '文件已开始自动下载，如果没有开始，请 ',
      ...
      combos: {
        ios: {
          ...
          search_bar: '搜索栏',
          ios_status_bar: '状态栏',
          iphone_x_status_bar: 'iPhone X<br>状态栏',
          ...
          notification: '消息通知',
          widget_base: '通知',
          iphone_keyboard: 'iPhone 键盘',
          ipad_keyboard: 'iPad 键盘'
        },
        android: {
          app_bar: '顶部导航',
          app_bar_2: '顶部导航2',
          navbar: '底部导航',
          android_status_bar: '状态栏',
          search: '搜索栏',
          button: '按钮',
          android_check: '多选',
          android_radio: '单选',
        ...
        wechat: {
          nav_ios: 'iOS 导航',
          nav_android: 'Android 导航',
          button_normal: '常规按钮',
          button_icon: '图标按钮',
          button_alert: '警告按钮',
          button_line: '线框按钮',
          toast_icon_text: '图标浮窗',
          toast_icon: '状态浮窗',
          chat_list: '联系人列表',
          chat_list_text: '消息列表',
          chat_list_text_icon: '联系人信息',
          list_with_icon: '单行列表',
          list_text: '单项输入',
          list_with_img: '缩略图列表',
          list_title_2: '双行标题',
          ...
          list_checkbox: '多选列表',
          list_img: '图文列表',
          list_title_img_more: '多行图文列表',
          list_title_source: '文章列表',
          card_pic_more: '大图卡片',
          card_title_pic_more: '标题卡片',
          card: '多文章卡片',
          alert_button: '弹窗',
          alert_confirm: '确认弹窗',
          alert_pic: '图片弹窗',
          card_pic_title: '优惠券',
          card_pic_source: '优惠券卡片'
        },
        ant: {
          button_main: '主按钮',
          button_icon: '带图标按钮',
          ...
          alert_icon: '常驻提醒',
          alert_button: '文字链接提醒',
          alert_title_icon: '详情提醒',
          datepicker: '日期选择',
          input_number: '数字输入框',
          button_upload: '上传按钮',
          drag_upload: '上传区域',
          progress_upload: '上传进度',
          upload_avatar: '上传头像',
          avatar: '头像',
          slider: '滑块',
          slider_dots: '状态滑块',
        ...
        element: {
          ...
          tab_style_4: '导航4',
          pagination_bg: '分页器',
          pagination_bigbang: '分页器 2',
          notification_basic: '提示',
          notification_ok: '提示确认',
          notification_ask: '警示',
          table1: '表格',
          table2: '表格 2',
          table3: '表格 3',
      ...
      no_combos: '空空如也，快创建一个属于你的组合吧！也可以选中组件拖拽到此处，或右键选择『添加到自定义组合』即可',
      no_templates: '空空如也，快创建一个属于你的母版吧！',
      no_match_combos: '未搜到相关组合',
      no_match_templates: '未搜到相关母版',
      no_icons: '没有符合条件的图标',
      ...
      w: {
        ...
        rich_text_placeholder: '双击编辑文本'
      },
      duplicate: '复制并粘贴',
      paste_to_cursor: '粘贴到鼠标位置',
      move_left: '左移',
      move_right: '右移',
      move_up: '上移',
      move_down: '下移',
      shrink_all: '收拢所有父页',
      toggle_left_panel: '收缩左侧面板',
      toggle_right_panel: '收缩右侧面板',
      click: '鼠标单击',
      select_one: '单选',
      append_select: '加选',
      partial_select: '选取部分',
      ...
      sketch_screen_tip: '此页面高度需通过 Sketch 进行调整并重新上传',
      ...
      link_back_desc: '链接上一页：拖动组件的链接按钮到此处可以创建返回链接，运行状态下，点击返回链接将返回到当前页面的上一页。',
      select_panel_states: '选择一个状态创建母版链接',
      state_link_tutorial: '观看母版链接教学视频',
      template_screen: '母版状态',
      new_state: '新状态',
      search_state: '搜索状态',
      global_state: '全局状态',
      default_state: '默认状态',
      ...
      remove_parent_state_only: '只删除父状态',
      remove_all_state: '删除父状态及所有子状态',
      cant_remove_screen: '您的项目需要至少一个页面。',
      cant_remove_template_state: '您的母版需要至少一个状态。',
      ...
      step_4_title: '运行',
      step_4_desc: '点击运行，可模拟真机演示效果；分享二维码，协同查看及时获取他人反馈；开发者模式，可一键获取标注参数。',
      step_5_title: '回收站',
      step_5_desc: '也叫做页面回收站。可以在这里一键恢复误删的页面。',
      step_6_title: '教程',
      step_6_desc: '需要帮助？来这看看官方教程吧，解决你的所有疑问！',
      preview: {
        preview: '预览',
        pages: '页面',
        images: '切图',
        ...
        search: '搜索页面',
        guide_login: '请登录后使用',
        client_load_a: '下载墨刀客户端',
        client_load_tip: '以获取更好的标注体验',
        setting: '设置',
        share: '分享',
        fullscreen: '全屏模式',
        firstScreen: '已经是第一页',
        ...
        comment: {
          ...
          comment_placeholder: 'Shift + Enter 换行',
          comment_create: '回复',
      ...
      preview_panel: {
        ...
        web: '网页',
        no_slice: '当前项目没有切图',
        slice_in_sketch: '你可以尝试在 Sketch 中切图',
        download_sketch: '下载 Sketch 插件',
        not_incurrent_screen: '该素材不在当前页',
        not_match: '未搜到相关页面',
        stroke: '描边'
      },
      ...
      renew_prompt: {
        ...
        newscreens: '目标项目已超20页，',
        exportable: '不支持下载「{format}」，',
        inspectable: '不支持开启开发者模式，',
        slices: '不支持切片下载，',
        collaboration: '您无法继续编辑此项目，',
        collaborators: '最多支持邀请 {collaborators} 个协作成员，',
      ...
      global_state_alert: '<p class="desc">当前页面有不止 1 个页面状态，请切换到全局状态（状态 0）添加新组件。</p> <p class="desc"><strong>注意：</strong>在全局状态中的操作将会同步到所有其他状态。</p> <p class="desc" style="margin: 2em 0 -1em; text-align: center;"><img src="/images/workspace/global_state_zh-CN.png" width="220"></p>\n',
      del_app_title: '删除项目',
      del_app_desc_more: '\n    项目删除 2 周内，可在页面右下方的\n    <span class="recycle">\n      <span class="icon-recycle"></span> 回收站\n    </span>\n    恢复\n  ',
      fraud_warning: '<p class="desc"><strong>该 demo 使用墨刀制作，墨刀是在线的原型工具，用于制作应用演示模型。</strong></p> <p class="desc">任何要求转账、汇款、购买授权码的行为均是诈骗行为。除官方渠道 <a href="https://modao.cc">modao.cc</a> 外，通过其他渠道付费，墨刀概不负责。</p> <p class="desc">付费用户可去除此提示。</p>\n',
      fraud_confirm: '知道了，我不会转账',
      exit_app_title: '退出项目',
      dup_app_title: '复制项目',
      move_app_title: '移动项目',
      ...
      del_link_title: '删除链接',
      del_link_ingroup_desc: '当前组合内包含独立链接，是否删除原有独立链接并应用新的组合链接？',
      del_group_link_desc: '当前组合已创建链接，是否删除原有链接并应用最新的组件链接？',
      del_link_ingroup_confirm: '删除独立链接',
      del_group_link_confirm: '删除组合链接',
      ...
      del_state_title: '删除状态',
      del_state_desc: '您确定要删除状态<span class="quote"><span class="widget-name">%s</span></span>吗？',
      del_parental_state_desc: '<span class="quote"><span class="widget-name">%name</span></span>有 <b>%count 个子状态</b>，您要？',
      ...
      unsaved_desc: '%type<span class="quote"><span class="project-name">%name</span></span>还有更新尚未保存，请先保存再退出。',
      ...
      export_unsaved_desc: '项目<span class="quote"><span class="project-name">%name</span></span>还有更新尚未保存，请等待保存完成后再次点击下载。',
      export_unsaved_confirm: '保存并下载',
      regenerate_url_title: '重置分享链接',
      regenerate_url_desc: '此操作将会重新生成分享 URL，旧的 URL 将无法再访问此项目，确定要重新生成吗？',
      open_in_browser: '在浏览器中打开',
      open_in_client: '客户端打开',
      download_android_apk: '安卓 APK 离线下载',
      add_to_home_screen: '添加到主屏幕',
      download_ios: '下载墨刀客户端获得更佳展示体验',
      download_android: '下载墨刀客户端获得更佳展示体验',
      building_apk: '正在生成 APK 文件',
      account: {
        pay_success: '支付成功',
      ...
      guide_base: {
        ...
        zoom: {
          header: '快速缩放设计图',
          content: '\n        <p>鼠标: <kbd class="for-mac">⌘</kbd><kbd class="for-others">ctrl</kbd><span class="plus">+</span><span class="mouse">滚轮</span></p>\n        <p>快捷键: <kbd class="for-mac">⌘</kbd><kbd class="for-others">ctrl</kbd><span class="plus">+</span><kbd style="width: 42px;">+/-</kbd></p>\n        <p>按 <kbd style="width: 42px;">空格</kbd><span class="plus">+</span><span class="mouse">鼠标左键</span> 拖拽画布</p>\n      '
        },
        state: {
          header: '状态面板',
          content: '点击此图标再次 展开/收起 状态面板。'
        },
        main: {
          header: '外观设置',
          content: '选中组件后，点击此图标再次 展开/收起 外观设置面板。'
        },
        link: {
          header: '链接设置',
          content: '选中链接线后，点击此图标再次 展开/收起 链接设置面板。'
        },
        trash: {
          header: '回收站',
          content: '删除的页面可保存 14 天，请及时恢复重要页面。'
        }
      },
      demo_category: {
        all: '全部',
...
// # sourceMappingURL=i18n-zh-CN-13063f5bc8b3a8b45fc7.js.map
